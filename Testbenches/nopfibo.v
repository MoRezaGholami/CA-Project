module tb;
    ...
    initial begin
      ...
      // ============================================================
        ...
        // ============================================================
        // Fibonacci Sequence (1 to 10) - WITHOUT Data Forwarding (3 NOPs injected)
        // ============================================================
        ...
        instructions[3]  = 32'h00000000;  // nop
        instructions[4]  = 32'h00000000;  // nop
        instructions[5]  = 32'h00000000;  // nop
        instructions[6]  = 32'h01095020;  // add  $t2, $t0, $t1 -> F(3) = 2
        
        // Hazard: $t2 is not in Register File yet! (3 NOPs)
        instructions[7]  = 32'h00000000;  // nop
        instructions[8]  = 32'h00000000;  // nop
        instructions[9]  = 32'h00000000;  // nop
        instructions[10] = 32'h012A5820;  // add  $t3, $t1, $t2 -> F(4) = 3
        
        // Hazard: $t3 is not in Register File yet! (3 NOPs)
        instructions[11] = 32'h00000000;  // nop
        instructions[12] = 32'h00000000;  // nop
        instructions[13] = 32'h00000000;  // nop
        instructions[14] = 32'h014B6020;  // add  $t4, $t2, $t3 -> F(5) = 5
        
        // Hazard: $t4 is not in Register File yet! (3 NOPs)
        instructions[15] = 32'h00000000;  // nop
        instructions[16] = 32'h00000000;  // nop
        instructions[17] = 32'h00000000;  // nop
        instructions[18] = 32'h016C6820;  // add  $t5, $t3, $t4 -> F(6) = 8
        
        // Hazard: $t5 is not in Register File yet! (3 NOPs)
        instructions[19] = 32'h00000000;  // nop
        instructions[20] = 32'h00000000;  // nop
        instructions[21] = 32'h00000000;  // nop
        instructions[22] = 32'h018D7020;  // add  $t6, $t4, $t5 -> F(7) = 13
        
        // Hazard: $t6 is not in Register File yet! (3 NOPs)
        instructions[23] = 32'h00000000;  // nop
        instructions[24] = 32'h00000000;  // nop
        instructions[25] = 32'h00000000;  // nop
        instructions[26] = 32'h01AE7820;  // add  $t7, $t5, $t6 -> F(8) = 21
        
        // Hazard: $t7 is not in Register File yet! (3 NOPs)
        instructions[27] = 32'h00000000;  // nop
        instructions[28] = 32'h00000000;  // nop
        instructions[29] = 32'h00000000;  // nop
        instructions[30] = 32'h01CF8020;  // add  $s0, $t6, $t7 -> F(9) = 34
        
        // Hazard: $s0 is not in Register File yet! (3 NOPs)
        instructions[31] = 32'h00000000;  // nop
        instructions[32] = 32'h00000000;  // nop
        instructions[33] = 32'h00000000;  // nop
        instructions[34] = 32'h01E08820;  // add  $s1, $t7, $s0 -> F(10)= 55

        last_instr = 35; // ۳۵ دستور در مجموع (شامل مقداردهی اولیه و NOPها)
